---
title: "US Tax Filing Deadlines for Americans Living in the UK (2025)"
...
faqs:
  - q: "When is the US tax return deadline for Americans living in the UK?"
    a: "Americans residing outside the United States on the regular 15 April deadline receive an automatic two-month extension to 15 June. No form is required. Any tax owed still accrues interest from 15 April — the extension is for filing, not payment."
  - q: "Can I get more time beyond 15 June?"
    a: "Yes. Form 4868 extends the deadline to 15 October if filed by 15 June. A further discretionary extension to 15 December is available by written request. Extensions cover filing only — interest runs on unpaid tax from 15 April regardless."
  - q: "What is the FBAR deadline for Americans in the UK?"
    a: "The FBAR is due 15 April with an automatic extension to 15 October. No form is required for the FBAR extension. It is filed separately with FinCEN, not the IRS."
  - q: "When are US estimated tax payments due for Americans abroad?"
    a: "15 April, 15 June, 15 September, and 15 January. Americans with self-employment, rental, or investment income not subject to withholding typically need to make these payments to avoid an underpayment penalty."
  - q: "Does the June extension apply if I moved back to the US before 15 April?"
    a: "No. The automatic extension applies to citizens residing outside the US on 15 April. If you had returned by that date, the standard April deadline applies."
  - q: "What are the penalties for missing US tax deadlines?"
    a: "The failure-to-file penalty is 5% of unpaid tax per month, capped at 25%. The failure-to-pay penalty is 0.5% per month. Where the Foreign Tax Credit reduces US tax to zero, percentage penalties are generally zero too — but the return must still be filed. FBAR penalties start at $10,000 per non-wilful violation."
---
...
Failure-to-file: 5% of unpaid tax per month, capped at 25%. Failure-to-pay: 0.5% per month. Where reliefs reduce US tax to zero, percentage penalties are generally zero — but the return must still be filed. Flat penalties apply to missed information returns regardless of tax owed. Key expat dates are in our [US expat tax deadlines tool](/resources/calculators/us-expat-deadlines).
