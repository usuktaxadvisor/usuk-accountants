---
title: "Check-the-Box (Form 8832) for a UK Limited Company: When It Helps a US Owner"
description: "A check-the-box election can reclassify a single-owner UK limited company as a disregarded entity for US tax — removing Form 5471 and GILTI/NCTI. But it brings self-employment tax and a deemed liquidation. Here's when it helps and when it hurts."
date: "2026-06-27"
author: "sam-h"
reviewedBy: "briana"
category: "Business & Self-Employment"
faqs:
  - q: "What is a check-the-box election for a UK company?"
    a: "It's an election, made on IRS Form 8832, that changes how the IRS classifies your UK limited company for US tax purposes. A UK Ltd defaults to foreign-corporation treatment, but because it's an 'eligible entity' (not a per se corporation), a single owner can usually elect to treat it as a disregarded entity instead. That makes its income flow directly onto your personal US return and replaces Form 5471 with Form 8858 — but it has significant trade-offs."
  - q: "Does check-the-box remove Form 5471 and GILTI?"
    a: "For a single-owner company that elects disregarded-entity treatment, yes — the company leaves CFC status, so GILTI/NCTI and Form 5471 generally fall away, replaced by Form 8858 and direct reporting on Schedule C or E. That simplification is the main appeal. The catch is that direct reporting can expose the income to US self-employment tax, and the election itself triggers a deemed liquidation with possible tax consequences."
  - q: "What are the downsides of a check-the-box election?"
    a: "Three main ones: the income may become subject to US self-employment tax (15.3%) once it flows onto Schedule C, unless the Totalization Agreement applies; the election causes a deemed liquidation of the company for US tax purposes, which can create taxable gain; and the classification is generally locked for 60 months, so you can't freely switch back. It also doesn't suit multi-owner companies or group structures."
  - q: "Is check-the-box a good idea for my UK company?"
    a: "Sometimes — typically for a single-owner company with modest profits where the owner extracts most income anyway and values simpler reporting and foreign tax credit use. It's often a poor fit where you retain significant profit, have multiple shareholders, or the company owns other entities. It's a modelling decision with multi-year consequences, not a default cleanup move."
  - q: "Can I make a late check-the-box election?"
    a: "Possibly. There's relief (under Revenue Procedure 2009-41) that can allow a late election with a reasonable-cause statement, sometimes retroactive to formation, which can remove Form 5471 and GILTI exposure for affected years. It has strict conditions, so it's not guaranteed — but it's a recognised route worth exploring if you've discovered the issue late."
---
...
- you **retain significant profit** in the company (you may *want* corporate treatment plus a [Section 962 election](/resources/blog/section-962-election-explained) instead);
...
- [GILTI/NCTI rules for Americans with UK companies](/resources/blog/gilti-ncti-rules-americans-uk-companies) — what this election can remove.
- [Self-employed in the UK? Your US tax obligations explained](/resources/blog/self-employed-in-uk-us-tax-obligations) — the Totalization Agreement that may shield you from self-employment tax.
