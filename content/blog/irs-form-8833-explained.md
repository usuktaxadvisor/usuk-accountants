---
title: "IRS Form 8833 Explained: Who Must File It and When Is It Required?"
...
faqs:
  - q: "Do I always need Form 8833 if I use the US-UK treaty?"
    a: "No. Form 8833 is only required when you take a position that overrides or modifies the Internal Revenue Code to reduce your US tax. Many common reliefs — such as the Foreign Tax Credit and the Foreign Earned Income Exclusion — are based in the Code itself, not in a treaty override, and generally do not require Form 8833."
  - q: "What is the penalty for not filing Form 8833 when required?"
    a: "Where disclosure is required and you fail to file, the penalty is generally 1,000 US dollars per position for individuals, and 10,000 US dollars per position for C corporations. Beyond the penalty, failing to disclose can weaken your position if the IRS later examines the return. Confirm current figures against the IRS Form 8833 instructions."
  - q: "Does Form 8833 remove my FBAR or FATCA obligations?"
    a: "No. Treaty positions change how income is taxed; they do not switch off your separate reporting obligations. FBAR (FinCEN Form 114) and FATCA (Form 8938) filing requirements are independent of any treaty position, and confusing the two is a common and costly mistake."
  - q: "Can Green Card holders use the treaty tie-breaker rules?"
    a: "Yes, but with serious caution. A Green Card holder who claims to be treated as a UK resident under the treaty's tie-breaker rules can be treated as having abandoned US residency for tax purposes, which has significant consequences. This is an area where specialist advice is essential before acting."
  - q: "Is my UK pension tax-free lump sum exempt from US tax under the treaty?"
    a: "This is a genuinely contested area. The conservative, IRS-aligned view is that the saving clause allows the US to tax the lump sum despite its UK tax-free status; a minority view treats it as exempt under a specific treaty provision but requires a Form 8833 disclosure and carries audit risk. The correct position depends on your facts."
  - q: "Which US tax forms does Form 8833 interact with?"
    a: "Form 8833 is attached to your US return (Form 1040) when you take a qualifying treaty position. It generally does not affect the Foreign Tax Credit (Form 1116) or Foreign Earned Income Exclusion (Form 2555), which are Code-based, and it does not remove FBAR or FATCA reporting obligations."
---
...
If you are considering a treaty position on your US return, [book a consultation](/book?tier=individual) with our cross-border specialists — we will assess whether Form 8833 applies to you and how to document it correctly. You may also find our guide to the [US-UK tax treaty](/resources/blog/us-uk-tax-treaty-explained) helpful.
