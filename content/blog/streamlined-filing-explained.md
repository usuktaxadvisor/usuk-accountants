...
faqs:
  - q: "What is the IRS Streamlined Filing procedure?"
    a: "It is an IRS programme that lets US taxpayers who failed to file returns or report foreign accounts — because they did not know they had to, rather than deliberately — catch up without the usual penalties. For US citizens living abroad, the relevant route is the Streamlined Foreign Offshore Procedures, which typically involves filing the last three years of tax returns and six years of FBARs, together with a certification that the failure was non-wilful."
  - q: "Who qualifies for the Streamlined Foreign Offshore Procedures?"
    a: "In general, US citizens or Green Card holders who meet a non-residency requirement and whose failure to file was non-wilful — meaning it resulted from a genuine lack of awareness rather than deliberate avoidance. Qualifying as a foreign resident is what unlocks the more favourable, typically penalty-free, version of the programme. The specific tests should be checked against current IRS guidance for your circumstances."
  - q: "How many years of returns and FBARs do I need to file?"
    a: "The Streamlined Foreign Offshore Procedures generally require the most recent three years of delinquent or amended tax returns and six years of FBARs (FinCEN Form 114), along with a signed certification explaining why the failure to file was non-wilful. The exact years depend on the filing deadlines that have passed at the time of submission."
  - q: "Will I have to pay penalties under Streamlined Filing?"
    a: "For those who qualify under the Foreign Offshore Procedures as non-residents, the programme is generally penalty-free — you pay any tax due plus interest, but not the failure-to-file, failure-to-pay, or FBAR penalties that could otherwise apply. This favourable treatment is a key reason the programme exists and why using it correctly matters."
  - q: "What is a non-wilful certification?"
    a: "It is a signed statement, submitted as part of a Streamlined filing, explaining the specific reasons your failure to file was non-wilful — that it arose from a good-faith misunderstanding rather than an intent to evade. It is the heart of the submission and the document most worth preparing carefully, because it is what supports your eligibility for the programme."
  - q: "What should I not do if I am behind on US taxes?"
    a: "Do not simply start filing from the current year and hope earlier years are overlooked — this is known as a quiet disclosure, the IRS disapproves of it, and it can forfeit the protection Streamlined would have given you. Do not ignore the issue either, as programmes can change. The safe route is to assess your eligibility for Streamlined before acting."
---
...
1. **Establish eligibility** — confirm you meet the non-residency and non-wilful tests before doing anything else.
2. **Gather the documents** — income records, foreign account details, and prior filings if any.
3. **Prepare the returns and FBARs** for the required years.
4. **Draft the certification carefully** — this is not a formality.
5. **Submit through the programme** rather than through a piecemeal or quiet approach.
...
If you have fallen behind on US filings while living abroad, [book a consultation](/book?tier=individual) and we will assess honestly whether the Streamlined Procedures fit your situation and guide you through them. Our guides to [IRS Form 8833](/resources/blog/irs-form-8833-explained) and the [US-UK tax treaty](/resources/blog/us-uk-tax-treaty-explained) provide useful background on the obligations that continue afterwards.
