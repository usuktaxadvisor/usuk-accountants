---
title: "FEIE or Foreign Tax Credit: Which Should I Use in the UK?"
description: "Two main tools stop Americans in the UK being taxed twice: the Foreign Earned Income Exclusion and the Foreign Tax Credit. For most people in the UK, the Foreign Tax Credit is the better fit — here's why, and when the FEIE still makes sense."
date: "2026-06-26"
author: "sam-h"
reviewedBy: "briana"
category: "US Tax"
...
2. Using the FTC frequently leaves you with **surplus credits to carry forward**, which can be valuable later — for example, against a future [UK pension lump sum](/services/us-expat-tax/us-uk-tax-treaty) or other US tax. The FEIE generates no such carryforward.
...
> Want a sense of how the two compare for your numbers? Our [double-tax estimator](/resources/calculators/double-tax-estimator) gives you a rough comparison before you commit.
