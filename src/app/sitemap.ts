...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  '/services/us-expat-tax/us-tax-returns/hub',
  '/resources/guides/delinquent-fbar',
  '/resources/calculators/delinquent-fbar-penalty',
    ...
    '/resources/calculators/exit-tax',
    '/resources/calculators/late-filing-penalty',
    '/resources/calculators/paye-refund',
    ...
    '/resources/forms/form-2555',
    '/resources/forms/form-8621',
    '/resources/forms/form-3520',
    '/resources/forms/form-3520-a',
    ...
    priority:
      path === '' ? 1
      : path === '/book' || path === '/contact' || path === '/pricing' ? 0.9
