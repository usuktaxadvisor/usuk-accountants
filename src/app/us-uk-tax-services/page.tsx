...
const faqs = [
  ...
  { q: 'How does pricing work?', a: 'We offer a £550 consultation, then a paid strategy session for detailed planning. Service pricing is bespoke and based on complexity, with a fixed-scope quote provided before any work begins — so you always know the cost in advance.' },
