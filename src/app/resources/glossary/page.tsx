...
export default function GlossaryIndex() {
  ...
  return (
    <PageShell
      ...
      ctaIntro="If one of these touches your situation, a short conversation will tell you exactly where you stand. The first consultation is £350 for a focused 30 minutes."
    >
