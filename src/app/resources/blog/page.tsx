...
export default function BlogIndex() {
  ...
  return (
    <PageShell
      ...
      ctaIntro="Every situation is different. Book a £350 30-minute consultation and we'll give you a clear answer for yours — or email us free for a quick question."
    >
      <Section tone="white">
        <Container>
          {posts.length === 0 ? (
