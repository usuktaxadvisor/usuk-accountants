...
export default function FeieVsFtcPage() {
  return (
    <PageShell
      ...
      ctaIntro="It's one of the most consequential and long-lasting choices in US expat tax. We'll model both on your real numbers — the consultation is £200 for a focused 30 minutes."
    >
      <Section tone="white">
        <Container>
          <FeieVsFtcCalculator />
