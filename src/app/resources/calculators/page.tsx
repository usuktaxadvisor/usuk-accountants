...
const faqs = [
  { q: 'Are these tax calculators free to use?', a: 'Yes. Every tool here is free and gives an indicative estimate to help you understand your cross-border position. They are educational, not formal advice — for a precise answer we offer a free consultation.' },
...
export default function CalculatorHub() {
  return (
    <PageShell
      ...
      ctaIntro="The tools give you a direction. A free consultation gives you certainty."
    >
      <Section tone="white">
        <Container>
