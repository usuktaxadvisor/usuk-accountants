...
export const calculators: CalculatorMeta[] = [
  ...
  { slug: 'self-assessment-deadline', title: 'Self Assessment Deadline & Penalty', description: 'Find your filing deadlines and estimate HMRC late penalties.', iconKey: 'calculator', status: 'coming-soon' },
  ...
  { slug: 'remittance-basis', title: 'Non-Dom Remittance Basis Estimator', description: 'Explore whether the remittance basis could suit your UK position.', iconKey: 'treaty', status: 'coming-soon' },
  { slug: 'corporation-tax', title: 'UK Corporation Tax Estimator', description: 'Estimate your UK company\u2019s Corporation Tax at current rates.', iconKey: 'bank', status: 'coming-soon' },
  { slug: 'take-home-pay', title: 'US vs UK Take-Home Pay', description: 'Compare net pay across the two systems when considering a move.', iconKey: 'planning', status: 'coming-soon' },
];
