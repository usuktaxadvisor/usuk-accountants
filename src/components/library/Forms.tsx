    ...
    return (
      <div className="rounded-2xl border border-gold/40 bg-gold/10 p-8 text-center">
        ...
        <p className="mt-2 text-sm text-muted">
          ...
          with available times and a secure link to confirm and pay for your £350 consultation. Prefer a
      ...
      {step === 2 && (
        <div className="space-y-4">
          <div className="rounded-lg bg-porcelain p-4 text-sm">
            <p className="text-muted">Booking a £350 30-minute consultation for:</p>
